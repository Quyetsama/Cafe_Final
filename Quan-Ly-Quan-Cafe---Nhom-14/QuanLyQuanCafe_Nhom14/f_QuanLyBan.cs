...
{
    public partial class f_QuanLyBan : Form
    {
        string ID;

        DataTable dataExcel;

        public static f_QuanLyBan instance;
        public static f_QuanLyBan Instance
        {
            get
            {
                if (instance == null)
                    instance = new f_QuanLyBan();
                return instance;
            }
        }
        ...
        private void f_QuanLyBan_Load(object sender, EventArgs e)
        {
            LoadPosition();
            LoadTable();
        }
