...
{
    public partial class f_QuanLySanPham : Form
    {
        DataTable dataExcel;
        ...
        public static f_QuanLySanPham instance;
        public static f_QuanLySanPham Instance
        {
            get
            {
                if (instance == null)
                    instance = new f_QuanLySanPham();
                return instance;
            }
        }


        public f_QuanLySanPham()
        {
            InitializeComponent();
        }

        private void f_QuanLySanPham_Load(object sender, EventArgs e)
        {
